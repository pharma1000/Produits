...
window.onload = function() {
    fetch(API_URL)
        ...
        .catch(err => {
            document.getElementById('loader-shell').innerHTML = "Error loading data. Check API URL.";
        });
};
...
function submitOrder(e) {
    ...
    // UI Feedback
    const msg = (method === 'magasin') ? "Nous vous attendons en pharmacie." : "Commande enregistrée. Nous vous contacterons.";
...
function renderCheckout() {
    ...
    document.getElementById('checkout-page').innerHTML = `<div class="container"><div class="return-bar" onclick="showPage('home')">← RETOUR</div><h2>Panier</h2>${items || '<p>Vide</p>'}
